    ...
    class CurrencyViewHolder(view: View): BaseAdapter.BaseViewHolder(view) {
        ...
        override fun bind(item: Any) {
            let {
                ...
                view.tvMarketCapChange.text = "%.5s%%".format(item.priceChangePercentage24h.toString())
                ...
                if (priceChangePercentage24h >= 0) {
                    view.tvMarketCapChange.setTextColor(Color.parseColor("#00FF00"))
                } else {
                    view.tvMarketCapChange.setTextColor(Color.parseColor("#F44336"))
                }
        }
